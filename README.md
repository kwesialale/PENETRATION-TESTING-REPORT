...
| Field | Detail |
|---|---|
| **Pentester Name (Cybersecurity Professional)** | **[Your Name]** |
| **Program/Batch** | Cybersecurity Program — Networkwalks |
...
Week 2 gave me a hands-on run-through of the two things that typically kick off a security assessment: gathering what's publicly available about a target, and then actively scanning to see what's reachable on a network.
...
*Terminal and GUI screenshots captured during testing (stored in the `screenshots/` folder):*
...
![curl output](screenshots/04-curl-headers.png)
...
![Zenmap scan output](screenshots/07-zenmap-scan.png)
